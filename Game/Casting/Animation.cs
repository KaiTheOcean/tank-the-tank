...
namespace Tank.Game.Casting
{
    ...
    public class Animation 
    {
        ...
        /// <summary>
        /// Gets the animatino rate or frames between images
        /// </summary>
        /// <returns>The animatino rate</returns>
        public int GetRate()
        {
            return rate; 
        }
        ...
        /// </summary>
        /// <returns>The next images</returns>
        public Images NextImage()
        {
